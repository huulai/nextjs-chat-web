...
export type RemoveFriendMutation = {
  __typename?: "Mutation";
  removeFriend: { __typename?: "Friend"; id: string };
};
...
const RemoveFriendDocumentString = print(RemoveFriendDocument);
...
export function getSdk(
  ...
  return {
    AddFriend(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<AddFriendMutation>(
            AddFriendDocumentString,
            variables,
    ...
    refreshTokens(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<RefreshTokensMutation>(
            RefreshTokensDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "refreshTokens",
    ...
    RemoveFriend(
      variables: RemoveFriendMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<{
      data: RemoveFriendMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<RemoveFriendMutation>(
            RemoveFriendDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "RemoveFriend",
    ...
    SignIn(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<SignInMutation>(SignInDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "SignIn",
    ...
    SignUp(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<SignUpMutation>(SignUpDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "SignUp",
    ...
    UpdateFriend(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<UpdateFriendMutation>(
            UpdateFriendDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "UpdateFriend",
    ...
    Friends(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<FriendsQuery>(FriendsDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Friends",
